...
contactRouter.post('/', verifyUser, validateSchema(FindContactSchema), asyncWrapper(contactController.create));
contactRouter.get('/', verifyUser, asyncWrapper(contactController.getAll));
